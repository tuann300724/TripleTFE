    ...
    return (
        <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-100 dark:bg-slate-900 px-4 py-12 sm:px-6 lg:px-8 transition-colors duration-300">
            ...
            <div className="absolute top-6 left-6 sm:top-8 sm:left-8 z-50">
                <Link to="/login" className="inline-flex items-center gap-2 text-sm font-medium text-slate-500 dark:text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors duration-300">
            ...
            <div className="relative w-full max-w-md space-y-8">
                ...
                <FadeIn>
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <h2 className="mt-6 text-center text-3xl font-extrabold text-slate-900 dark:text-white">Tạo tài khoản mới</h2>
                    ...
                    >
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="relative">
                                ...
                                <input type="email" required placeholder="name@example.com" value={email} onChange={e => setEmail(e.target.value)} className={inputClass} />
                            </div>
                        </div>
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="relative">
                                ...
                                <input type="tel" required placeholder="0987654321" value={phone} onChange={e => setPhone(e.target.value)} className={inputClass} />
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-2 py-1">
                            <label className="flex items-center gap-2 cursor-pointer">
                                ...
                                />
                                <span className="text-sm text-slate-600 dark:text-slate-300">Tôi đồng ý với các điều khoản dịch vụ và chính sách bảo mật</span>
                            </label>
                        </div>

                        {error && (
                            <div className="text-red-500 dark:text-red-400 text-sm text-center font-semibold bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-500/20 rounded-xl py-2">
                                {error}
                            </div>
                        )}
                    ...
                    <div className="relative flex py-2 items-center">
                        ...
                        <span className="flex-shrink mx-4 text-slate-400 dark:text-slate-500 text-xs font-semibold uppercase tracking-wider">Hoặc đăng ký bằng</span>
                        <div className="flex-grow border-t border-slate-200 dark:border-white/10"></div>
                    </div>
                    ...
                    <div className="text-center text-sm text-slate-500 dark:text-slate-400">
                        Đã có tài khoản?{" "}
                        <Link to="/login" className="font-semibold text-emerald-600 dark:text-emerald-400 hover:text-emerald-500 dark:hover:text-emerald-300 transition-colors duration-300">
                            Đăng nhập ngay
                        </Link>
                    </div>
                    </div>
